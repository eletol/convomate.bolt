      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <div className="space-y-6">
            {[
              { label: 'Excellent', percentage: 65, color: 'bg-green-500' },
              { label: 'Good', percentage: 25, color: 'bg-blue-500' },
              { label: 'Fair', percentage: 7, color: 'bg-yellow-500' },
              { label: 'Poor', percentage: 3, color: 'bg-red-500' },
            ].map((rating) => (
              <div key={rating.label}>
                <div className="flex justify-between text-sm mb-1">
                  <span className="text-gray-600">{rating.label}</span>
                  <span className="text-gray-900">
                    <AnimatedNumber value={rating.percentage} />%
                  </span>
                </div>
